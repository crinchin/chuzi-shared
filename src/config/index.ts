...
export const REALMS: Record<RealmId, RealmDefinition> = {
  cosmos: {
    ...
    lexicon: {
      ...
      untitled_scene: "Untitled Planet",
      ...
      editor_scene_type_label: "Planet",
      ...
      editor_create_scene_before: "Insert Planet Before",
      editor_create_scene_after: "Insert Planet After",
      editor_create_scene_ahead: "Create New Planet",
      editor_create_next_scene: "Chart Next Planet",
