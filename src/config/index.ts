...
export const REALMS: Record<RealmId, RealmDefinition> = {
  cosmos: {
    ...
    lexicon: {
      ...
      draft: "Draft",
      no_scenes_yet: "No stars in this chart yet.",
      ...
      editor_save: "Lock In",
      editor_cancel: "Abort",
      editor_create_scene: "Chart Star",
      editor_create_scene_plain: "Create New Scene",
      editor_create_scene_before: "Insert New Star Before",
      editor_create_scene_after: "Insert New Star After",
      editor_create_scene_ahead: "Create New Star",
      editor_create_next_scene: "Chart Next Star",
      editor_create_scene_cost: "1 Stardust",
      editor_delete_scene_cta: "Delete Star",
      editor_delete_scene_confirm: "Click again to confirm",
      editor_scene_locked_delete: "Start star cannot be deleted.",
      ...
      chuzi_ai_generate: "Generate scene",
      ...
      chuzi_ai_scene_continue_default: "Continue the story with the next scene. Leave the narrative open-ended.",
      chuzi_ai_scene_continue_vibes: "Stay in the same tone and genre ({vibes}).",
      chuzi_ai_scene_continue_characters: "Keep roughly {count} characters in play.",
      chuzi_ai_scene_continue_hook: "Write the next scene continuing from where the story left off. Do not end or resolve the story.",
      editor_scene_nav: "Scene navigation",
      editor_scene_title_hint: "Click to rename this star",
      ...
      cosmos_cluster_published: "Broadcast Nebula",
      cosmos_cluster_unpublished: "Shipyard Nebula",
      cosmos_cluster_limited: "Relay Nebula",
      cosmos_cluster_jettisoned: "Jettison Nebula",
      jettison_unjettison: "Recover",
      jettison_promote: "Return to Shipyard",
      jettison_purge_story: "Purge",
      jettison_purge_all: "Purge All",
      jettison_days_remaining: "{days}d remaining",
      nav_bar_empty_nebula: "No star systems",
      nebula_chuzi: "CHUZI!",
      published_version_label: "Version",
      system_story_create: "New reserved story",
      publish_tier_private: "Private",
      publish_tier_limited: "Limited access",
      publish_tier_worldwide: "Worldwide",
      hud_unpublish_control: "Jettison",
      hud_retract_control: "Retract",
      unpublish_confirm_hint: "Tap again to confirm",
      create_publish_hint: "Add ratings, genre & coverbox when you broadcast.",
      generator_create_upload: "Create / Upload Transmission",
      generator_generate: "Generate with Chuzi AI",
      generator_vibes_prompt: "Choose your vibes",
      generator_vibes_required: "Pick at least one vibe.",
      generator_audience_prompt: "Who\u2019s your audience?",
      generator_audience_placeholder: "Select reading level",
      generator_characters_prompt: "How many characters?",
      generator_details_prompt: "Any details to add?",
      generator_details_placeholder: "Describe your universe\u2026",
      generator_record_cta: "Speak your universe",
      editor_ai_generate: "Generate Transmission",
      editor_ai_generating: "Transmitting Signal\u2026",
      editor_ai_mood_question: "What energy should this star radiate?",
      editor_ai_style_question: "What vision style for this transmission?",
      editor_ai_prompt_question: "Describe this star\u2019s landscape",
      ...
      spending_add_credits_continue: "Add credits to continue",
      editor_ai_generating_scene: "Star forming\u2026",
      ...
      editor_add_sound_music: "Add Sound / Music",
      editor_add_fx: "Add FX",
      editor_node_list_section: "Transmission Layers",
      editor_exit_choice_label: "Go To The End",
      editor_bg_layer_label: "Background",
      editor_remove_layer: "Remove",
      editor_new_node: "New\u2026",
      editor_new_text: "Lines of Text",
      editor_new_choice: "Choice",
      editor_new_image: "Image",
      editor_new_video: "Video",
      editor_new_music: "Music",
      editor_new_sound: "Sound Effect",
      editor_new_logic: "Logic",
      editor_new_credits: "Chosen by\u2026",
      editor_credits_layer: "Credits",
      editor_logic_mode_set: "Set Variable",
      editor_logic_mode_evaluate: "Evaluate",
      editor_logic_variable_label: "Variable",
      editor_logic_value_label: "Value",
      editor_logic_operator_label: "Condition",
      editor_logic_then_layers: "Then activate layers",
      editor_logic_new_variable: "New variable\u2026",
      editor_insert_star_menu: "Insert New Star\u2026",
      editor_select_node_hint: "Select a layer to edit",
      editor_effect_describe_prompt: "Describe what you want in detail",
      editor_effect_share_toggle: "Allow others to use this?",
      editor_effect_share_yes: "Yes, share with others",
      editor_effect_share_no: "No, keep it private",
      editor_effect_generating: "Generating\u2026",
      ...
      editor_preview_empty_hint: "Begin transmission",
      editor_preview_interact_hint: "Preview — drag transmission to position, resize from corner",
      ...
      editor_choices_empty_hint: "Set a goto star or add a choice to branch the story.",
      editor_goto_none: "None",
      editor_choice_label: "Choice",
      editor_choice_display_label: "Signal Label",
      editor_choice_display_label_hint: "Leave blank to hide the label beneath the arrow. Lexicon keys like viewer_continue resolve to realm text.",
      editor_choice_display_label_empty: "No label",
      editor_choice_display_label_preview: "Preview",
      editor_choice_exit_target_hint: "Terminal exit — ends the story for viewers.",
      ...
      viewer_close: "Exit",
      viewer_complete: "End Transmission",
      viewer_stage_label: "Viewport",
      viewer_choose_path: "Choose",
      viewer_scrub_label: "Playback position",
      ...
      all_nav_search_placeholder: "Scan transmissions\u2026",
      all_nav_sort_label: "Order by",
      all_nav_empty_nebula: "No transmissions",
      catalog_order_label: "Sort by",
      catalog_order_newest: "Newest Transmission",
      catalog_order_oldest: "Oldest Transmission",
      catalog_order_most_viewed: "Most viewed",
      catalog_order_least_viewed: "Least viewed",
      ...
      experience_mapping_story_label: "Star System",
      experience_mapping_scene_label: "Star",
      ...
      experience_mapping_delete_story: "Delete star system",
      experience_mapping_delete_scene: "Delete star",
      ...
      auth_signin_subtitle: "Sign in with your username or email.",
      auth_sign_up_button: "Create account",
      auth_username_placeholder: "Username",
      auth_identifier_placeholder: "Username or email",
      auth_sign_in_button: "Log in",
      auth_continue_with_google: "Continue with Google",
      auth_magic_link_code_placeholder: "Sign-in code",
      auth_magic_link_enter_code: "Enter the code from your email to sign in.",
      auth_magic_link_sent_code: "Check your email for your sign-in code.",
      auth_code_required: "Sign-in code is required.",
      auth_identifier_required: "Username or email is required.",
      auth_identifier_not_found: "No account found with that username.",
  ...
  wilds: {
    ...
    lexicon: {
      ...
      the_end: "Roots", // deprecated — no longer generated
      media_pool: "Undergrowth",
      scene_graph: "Canopy",
      watch_path: "Your trail",
      untitled_story: "Untitled Grove",
      untitled_scene: "Untitled Branch",
      ...
      editor_scene_type_label: "Clearing",
      editor_title_scene: "Start",
      ...
      editor_create_scene_plain: "Create New Scene",
      editor_create_scene_before: "Insert New Clearing Before",
      editor_create_scene_after: "Insert New Clearing After",
      editor_create_scene_ahead: "Plant Next Clearing",
      editor_create_next_scene: "Grow Next Branch",
      editor_create_scene_cost: "1 Pollen",
      editor_delete_scene_cta: "Delete Scene",
      editor_delete_scene_confirm: "Click again to confirm",
      editor_scene_locked_delete: "Start scene cannot be deleted.",
      ...
      chuzi_ai_scene_continue_hook: "Write the next scene continuing from where the story left off. Do not end or resolve the story.",
      editor_scene_nav: "Scene navigation",
      editor_scene_title_hint: "Click to rename this clearing",
      chuzi_ai_step_protagonist_hint: "Who is your main character? Name, age, personality, and what makes them interesting.",
      chuzi_ai_step_setting: "Setting",
      chuzi_ai_step_setting_hint: "Where and when does the story begin? Describe the world and their everyday life.",
      chuzi_ai_step_conflict: "Conflict",
      ...
      chuzi_ai_monomyth_return: "Monomyth: crossing the return threshold",
      chuzi_ai_monomyth_change: "Monomyth: freedom to live",
      cosmos_cluster_published: "Ancient Grove",
      cosmos_cluster_unpublished: "Seedling Nursery",
      cosmos_cluster_limited: "Canopy Clearing",
      cosmos_cluster_jettisoned: "Deadfall",
      jettison_unjettison: "Regrow",
      jettison_promote: "Return to Heartwood",
      jettison_purge_story: "Burn",
      jettison_purge_all: "Burn All",
      jettison_days_remaining: "{days}d remaining",
      nav_bar_empty_nebula: "No groves",
      nebula_chuzi: "CHUZI!",
      published_version_label: "Version",
      system_story_create: "New reserved story",
      publish_tier_private: "Private",
      publish_tier_limited: "Limited access",
      publish_tier_worldwide: "Worldwide",
      hud_unpublish_control: "Uproot",
      hud_retract_control: "Retract",
      unpublish_confirm_hint: "Tap again to confirm",
      create_publish_hint: "Add ratings, genre & coverbox when you bloom.",
      generator_create_upload: "Create / Upload Bloom",
      generator_generate: "Generate with Chuzi AI",
      generator_vibes_prompt: "Choose your vibes",
      generator_vibes_required: "Pick at least one vibe.",
      generator_audience_prompt: "Who\u2019s your audience?",
      ...
      generator_characters_prompt: "How many characters?",
      generator_details_prompt: "Any details to add?",
      generator_details_placeholder: "Describe your world\u2026",
      generator_record_cta: "Whisper your world",
      ...
      editor_add_sound_music: "Add Sound / Music",
      editor_add_fx: "Add FX",
      editor_node_list_section: "Bloom Layers",
      editor_exit_choice_label: "Go To The End",
      editor_bg_layer_label: "Background",
      editor_remove_layer: "Remove",
      editor_new_node: "New\u2026",
      editor_new_text: "Lines of Text",
      editor_new_choice: "Trail",
      editor_new_image: "Image",
      editor_new_video: "Video",
      editor_new_music: "Music",
      editor_new_sound: "Sound Effect",
      ...
      editor_logic_then_layers: "Then activate layers",
      editor_logic_new_variable: "New variable\u2026",
      editor_insert_star_menu: "Insert New Clearing\u2026",
      editor_select_node_hint: "Select a layer to edit",
      editor_effect_describe_prompt: "Describe what you want in detail",
      editor_effect_share_toggle: "Allow others to use this?",
      editor_effect_share_yes: "Yes, share with others",
      ...
      editor_timeline_label: "Timeline",
      editor_preview_label: "Preview",
      editor_preview_empty_hint: "Await the bloom",
      editor_preview_interact_hint: "Preview — drag bloom to position, resize from corner",
      editor_preview_play: "Play",
      editor_preview_pause: "Pause",
      editor_media_placeholder_imagery: "Imagery authoring is coming soon.",
      editor_media_placeholder_film: "Film authoring is coming soon.",
      ...
      editor_choice_display_label: "Trail Label",
      editor_choice_display_label_hint: "Leave blank to hide the label beneath the indicator. Lexicon keys like viewer_continue resolve to realm text.",
      editor_choice_display_label_empty: "No label",
      editor_choice_display_label_preview: "Preview",
      editor_choice_exit_target_hint: "Terminal exit — ends the story for viewers.",
      editor_flow_timeline: "Story Flow",
      ...
      tags_clear: "Clear tag filter",
      all_nav_search_placeholder: "Seek trails\u2026",
      all_nav_sort_label: "Order by",
      all_nav_empty_nebula: "No groves",
      catalog_order_label: "Sort by",
      catalog_order_newest: "Newest Sprout",
      catalog_order_oldest: "Oldest Sprout",
      catalog_order_most_viewed: "Most viewed",
      catalog_order_least_viewed: "Least viewed",
...
export const FALLBACK_LEXICON: Record<string, string> = {
  ...
  editor_create_scene_plain: "Create New Scene",
  editor_create_scene_before: "Insert new scene before",
  editor_create_scene_after: "Insert new scene after",
  editor_create_scene_ahead: "Create new scene",
  editor_create_next_scene: "Create next scene",
  ...
  wizard_back: "Back",
  wizard_next: "Next",
  wizard_vibes_hint: "Pick the genres and moods for your scene. Select multiple.",
  wizard_audience_hint: "Controls vocabulary, sentence length, and themes.",
  wizard_details_placeholder: "What happens next?",
  chuzi_ai_scene_create: "Create scene with Chuzi AI",
  chuzi_ai_scene_overwrite: "Rewrite scene with Chuzi AI",
  chuzi_ai_scene_brief: "Scene direction",
  chuzi_ai_scene_brief_hint: "Describe what should happen in this scene. Chuzi AI reads your existing story for characters, tone, and style.",
  ...
  chuzi_ai_scene_continue_hook: "Write the next scene continuing from where the story left off. Do not end or resolve the story.",
  editor_scene_nav: "Scene navigation",
  editor_scene_title_hint: "Click to rename this scene",
  ...
  cosmos_cluster_published: "Published",
  cosmos_cluster_unpublished: "Unpublished",
  cosmos_cluster_limited: "Limited",
  cosmos_cluster_jettisoned: "Jettisoned",
  jettison_unjettison: "Recover",
  jettison_promote: "Promote",
  jettison_purge_story: "Delete Permanently",
  jettison_purge_all: "Purge All",
  jettison_days_remaining: "{days}d remaining",
  nav_bar_empty_nebula: "No stories",
  nebula_chuzi: "CHUZI!",
  published_version_label: "Version",
  system_story_create: "New reserved story",
  publish_tier_private: "Private",
  publish_tier_limited: "Limited access",
  publish_tier_worldwide: "Worldwide",
  hud_unpublish_control: "Unpublish",
  hud_retract_control: "Retract",
  unpublish_confirm_hint: "Tap again to confirm",
  create_publish_hint: "You can add ratings, genre, and cover art when you publish.",
  generator_create_upload: "Create / Upload",
  generator_generate: "Generate",
  generator_vibes_prompt: "Vibes (choose as many as you\u2019d like)",
  generator_vibes_required: "Pick at least one vibe.",
  generator_audience_prompt: "Who\u2019s your audience?",
  generator_audience_placeholder: "Select reading level",
  generator_characters_prompt: "How many characters?",
  generator_details_prompt: "Any details to add?",
  generator_details_placeholder: "Add any details to help guide the story\u2026",
  generator_record_cta: "Speak your vision",
  chuzi_ai_monomyth_hero: "Hero\u2019s Journey: the protagonist",
  chuzi_ai_monomyth_world: "Monomyth: ordinary world",
  chuzi_ai_monomyth_you: "Story Circle: zone of comfort",
  chuzi_ai_monomyth_need: "Story Circle: something isn\u2019t right",
  ...
  editor_add_sound_music: "Add Sound / Music",
  editor_add_fx: "Add FX",
  editor_node_list_section: "Layers",
  editor_exit_choice_label: "Go To The End",
  editor_bg_layer_label: "Background",
  editor_remove_layer: "Remove",
  editor_new_node: "New\u2026",
  ...
  editor_logic_then_layers: "Then activate layers",
  editor_logic_new_variable: "New variable\u2026",
  editor_insert_star_menu: "Insert New Scene\u2026",
  editor_select_node_hint: "Select a layer to edit",
  editor_effect_describe_prompt: "Describe what you want in detail",
  editor_effect_share_toggle: "Allow others to use this?",
  editor_effect_share_yes: "Yes, share with others",
  ...
  editor_timeline_label: "Timeline",
  editor_preview_label: "Preview",
  editor_preview_empty_hint: "Preview will appear here",
  editor_preview_interact_hint: "Preview — drag to position, resize from corner",
  editor_preview_play: "Play",
  editor_preview_pause: "Pause",
  editor_media_placeholder_imagery: "Imagery authoring is coming soon.",
  editor_media_placeholder_film: "Film authoring is coming soon.",
  ...
  editor_goto_none: "None",
  editor_choice_label: "Choice",
  editor_choice_display_label: "Arrow Label",
  editor_choice_display_label_hint: "Leave blank to hide the label beneath the arrow. Lexicon keys like viewer_continue resolve to realm text.",
  editor_choice_display_label_empty: "No label",
  editor_choice_display_label_preview: "Preview",
  editor_choice_exit_target_hint: "Terminal exit — ends the story for viewers.",
  ...
  tags_clear: "Clear tag filter",
  all_nav_search_placeholder: "Search tags\u2026",
  all_nav_sort_label: "Order by",
  all_nav_empty_nebula: "No stories",
  catalog_order_label: "Sort by",
  catalog_order_newest: "Newest",
  catalog_order_oldest: "Oldest",
  catalog_order_most_viewed: "Most viewed",
  catalog_order_least_viewed: "Least viewed",
