...
export const REALMS: Record<RealmId, RealmDefinition> = {
  cosmos: {
    ...
    lexicon: {
      ...
      editor_create_scene_before: "Insert Star Before",
      editor_create_scene_after: "Insert Star After",
      ...
      editor_insert_star_menu: "Insert\u2026",
  ...
  wilds: {
    ...
    lexicon: {
      ...
      editor_create_scene_plain: "Create New Scene",
      editor_create_scene_before: "Plant Clearing Before",
      editor_create_scene_after: "Plant Clearing After",
...
export const FALLBACK_LEXICON: Record<string, string> = {
  ...
  editor_create_scene_plain: "Create New Scene",
  editor_create_scene_before: "Create scene before",
  editor_create_scene_after: "Create scene after",
