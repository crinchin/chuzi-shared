...
export const REALMS: Record<RealmId, RealmDefinition> = {
  cosmos: {
    ...
    lexicon: {
      ...
      chuzi_voiceover_add: "Add Chuzi voiceover",
      chuzi_voiceover_redo: "Redo voiceover",
      chuzi_voiceover_title: "Chuzi voiceover",
      chuzi_voiceover_direction: "Voice direction",
      chuzi_voiceover_direction_hint: "Describe how it should sound — tone, pace, accent, emotion (e.g. warm British narrator, slow and ominous).",
      chuzi_voiceover_redo_feedback: "What should change?",
      chuzi_voiceover_redo_hint: "Tell Chuzi what to adjust compared to the last take. The script stays the same unless you edit the text.",
      chuzi_voiceover_generate: "Generate voiceover",
      chuzi_voiceover_generating: "Generating voiceover\u2026",
      chuzi_voiceover_apply: "Add to effects",
      chuzi_voiceover_failed: "Voiceover generation failed.",
      chuzi_voiceover_empty_script: "Add scene text before generating a voiceover.",
      chuzi_voiceover_label: "Chuzi voiceover",
